...
def test_guest_should_see_login_link_from_main_page(browser: Union[webdriver.Chrome, webdriver.Firefox]):
    page = MainPage("http://selenium1py.pythonanywhere.com/", browser)
    page.open()
    page.should_be_login_link()


def test_guest_can_go_to_login_page_from_main_page(browser: Union[webdriver.Chrome, webdriver.Firefox]):
    page = MainPage("http://selenium1py.pythonanywhere.com/", browser)
    page.open()
